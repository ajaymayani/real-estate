...
const Contact = () => {
  return (
    ...
    viewport={{once: true}}
    id="Contact" className='text-center p-6 py-10 lg:px-32 w-full overflow-hidden'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to Make a Move? Let's Build Your Furure Together</p>
