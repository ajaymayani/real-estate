...
const Testimonails = () => {
  return (
    ...
    viewport={{once: true}}
    className='container mx-auto py-5 lg:px-32 w-full overflow-hidden' id = "Testimonials">
        ...
        <p className='text-center text-gray-500 mb-6 max-w-80 mx-auto'>Real Stories from Those Who Found Home with us</p>
